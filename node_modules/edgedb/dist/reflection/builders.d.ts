...
export declare class CodeBuilder {
    ...
    addDefaultImport: (name: string, fromPath: string, allowFileExt?: boolean, modes?: Mode[] | undefined) => void;
    addStarImport: (name: string, fromPath: string, allowFileExt?: boolean, modes?: Mode[] | undefined) => void;

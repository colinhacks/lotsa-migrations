...
const DEBUG = false;
exports.configFileHeader = `// edgedb-js query builder - to update run 'edgedb-generate'`;
function exitWithError(message) {
    console.error(message);
    process.exit(1);
}
exports.exitWithError = exitWithError;
async function generateQB({ outputDir, connectionConfig, target, }) {
    console.log(`Connecting to EdgeDB instance...`);
    let cxn;
    try {
        cxn = await (0, index_node_1.createClient)({
            ...connectionConfig,
            concurrency: 5,
        });
    }
    ...
    try {
        ...
        (0, generateOperatorTypes_1.generateOperatorTypes)(generatorParams);

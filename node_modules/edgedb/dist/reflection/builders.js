...
exports.DirBuilder = exports.CodeBuilder = exports.CodeBuffer = exports.t = exports.dts = exports.r = exports.js = exports.ts = exports.f = void 0;
...
class BuilderImportsExports {
    ...
    addImport(names, fromPath, allowFileExt = false, modes) {
        this.imports.add({
            type: "partial",
            fromPath,
            names,
    ...
    addDefaultImport(name, fromPath, allowFileExt = false, modes) {
        this.imports.add({
            type: "default",
            fromPath,
            name,
    ...
    addStarImport(name, fromPath, allowFileExt = false, modes) {
        this.imports.add({
            type: "star",
            fromPath,
            name,
    ...
    addExport(name, as, isDefault = false, modes) {
        this.exports.add({
            type: "named",
            name,
            as,
    ...
    addExportFrom(names, fromPath, allowFileExt = false, modes) {
        this.exports.add({
            type: "from",
            names,
            fromPath,
    ...
    addExportStarFrom(name, fromPath, allowFileExt = false, modes) {
        this.exports.add({
            type: "starFrom",
            name,
            fromPath,
    ...
    renderImports({ mode, moduleKind, helpers, }) {
        const imports = new Set();
        for (const imp of this.imports) {
            if (imp.modes && !imp.modes.has(mode)) {
                continue;
            }
            const esmFileExt = imp.allowFileExt && mode === "js"
    ...
    renderExports({ mode, moduleKind, refs, helpers, }) {
        ...
        for (const exp of this.exports) {
            ...
            switch (exp.type) {
                ...
                case "from":
                    if (moduleKind === "esm") {
                        exportsFrom.push(`export { ${Object.entries(exp.names)
                            .map(([key, val]) => {
                            if (typeof val === "boolean" && !val)
                                return null;
                            ...
                            .filter(val => val !== null)
                            .join(", ")} } from "${exp.fromPath}${exp.allowFileExt && mode === "js"
                ...
                case "starFrom":
                    if (moduleKind === "esm") {
                        exportsFrom.push(`export * ${exp.name !== null ? `as ${exp.name} ` : ""}from "${exp.fromPath}${exp.allowFileExt && mode === "js"
                            ? exp.fromPath.startsWith(".")
                                ? ".mjs"
                                : ".js"
                            : ""}";`);
...
class CodeBuilder {
    constructor(dirBuilder, dir) {
        ...
        Object.defineProperty(this, "addDefaultImport", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: this.importsExports.addDefaultImport.bind(this.importsExports)
        });
        Object.defineProperty(this, "addStarImport", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: this.importsExports.addStarImport.bind(this.importsExports)
        });
        ...
        Object.defineProperty(this, "addRefsDefaultExport", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: this.importsExports.addRefsDefaultExport.bind(this.importsExports)
        });
        ...
        Object.defineProperty(this, "addExportStarFrom", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: this.importsExports.addExportStarFrom.bind(this.importsExports)
        });
    }
    ...
    resolveIdentRef(identRef, importsExports) {
        ...
        let prefix = "";
        if (ref.dir !== this.dir) {
            const mod = adapter_node_1.path.basename(ref.dir, adapter_node_1.path.extname(ref.dir));
            prefix = `_${mod}`;
            let importPath = adapter_node_1.path.join(adapter_node_1.path.relative(adapter_node_1.path.dirname(this.dir), adapter_node_1.path.dirname(ref.dir)), mod);
...
class DirBuilder {
    ...
    async write(to, mode, moduleKind) {

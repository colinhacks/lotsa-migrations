import { Expression, BaseType, BaseTypeSet, Cardinality, ExpressionKind, cardinalityUtil, QueryableExpression } from "../reflection";
export declare type $expr_For<IterSet extends BaseTypeSet = BaseTypeSet, Expr extends Expression = Expression> = QueryableExpression<{

import { QueryableExpression, ExpressionKind, ObjectTypePointers, ObjectTypeSet, stripBacklinks, stripNonWritables, typeutil } from "../reflection";
...
export declare type $expr_Update<Root extends ObjectTypeSet = ObjectTypeSet, Shape extends UpdateShape<Root> = any> = QueryableExpression<{

...
import { Cardinality, ExpressionKind, isArrayType, isNamedTupleType, isObjectType, isTupleType, OperatorKind, TypeKind, util, } from "../reflection";
...
UNION (\n${indent(renderEdgeQL(expr.__expr__, ctx), 2)}\n)`);
        ...
        return `<${expr.__cardinality__ === Cardinality.AtMostOne ? "OPTIONAL " : ""}${expr.__element__.__name__}>$${expr.__name__}`;
    }
